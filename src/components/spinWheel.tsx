...
export default function EnhancedSpinWheel() {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-b from-gray-900 via-gray-800 to-gray-700 flex flex-col items-center justify-center p-4 relative overflow-hidden">
      {/* Left side flower decoration */}
      <div className="absolute left-0 top-0 w-1/2 h-full overflow-hidden pointer-events-none">
        <div
          className="absolute -left-1/2 top-0 w-full h-full animate-spin-slow"
        ...
        >
          <Image
            ...
            layout="fill"
            objectFit="contain"
            className="max-w-[50vw] max-h-[50vh] sm:max-w-[33vw] sm:max-h-[33vh] md:max-w-none md:max-h-none"
          />
        </div>
      </div>

      {/* Right side flower decoration */}
      <div className="absolute right-0 bottom-0 w-1/2 h-full overflow-hidden pointer-events-none">
        <div
          className="absolute -right-1/2 bottom-0 w-full h-full animate-spin-slow-reverse"
          style={{ animationDuration: "30s" }}
        >
          <Image
            src="/flower2.svg"
